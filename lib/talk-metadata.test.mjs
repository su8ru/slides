...
describe('transformTalkMetadata', () => {
  test('injects metadata directives and expands placeholders', () => {
    ...
    expect(transformed).toContain('image: https://slides.su8.run/260408-react-study/index.jpg');
    expect(transformed).toContain('url: https://slides.su8.run/260408-react-study');
